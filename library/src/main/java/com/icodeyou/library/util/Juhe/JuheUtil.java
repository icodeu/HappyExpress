package com.icodeyou.library.util.Juhe;
...
public class JuheUtil {
    ...
    //配置您申请的KEY
    public static final String APPKEY ="44e5c60c2666648f153135521d37a63c";

    //1.常用快递查询API
    public static String queryLogisticsInfo(String com, String no){
        String result =null;
